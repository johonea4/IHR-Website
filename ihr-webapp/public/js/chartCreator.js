        ...
        case 'line':
            ...
            var myChart = new Chart(context, {
                ...
                data: {
                    ...
                    datasets: [ buildRandomDataset('Asprin', 'red', duration, 20, 25), 
                    buildRandomDataset('Wafarin', 'blue', duration, 9, 15), 
                    buildRandomDataset('Vitamin D', 'green', duration, 1, 7) ]
                },
                options: options
            });
            return;
...
function buildRandomDataset(name, color, seedCount, seedMin, seedMax)
{
    return {
        label: name,
        backgroundColor: color,
        borderColor: color,
        data: generateSeeds(seedCount, seedMin, seedMax),
        fill: false
    }
}

function generateSeeds(seedCount, seedMin, seedMax)
{
    var seeds = [];
